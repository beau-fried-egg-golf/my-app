...
export default function GroupChatScreen() {
  ...
  }, [loadGroups, loadMessages, id, markGroupRead]);

  const handleSend = async () => {
    if (!text.trim() || sending || !id) return;
    setSending(true);
    try {
      const msg = await sendGroupMessage(id, text.trim());
    ...
    >
      ...
      <View style={styles.header}>
        <View style={styles.headerRow}>
          ...
          >
            <Ionicons name="people" size={18} color={Colors.black} style={{ marginRight: 8 }} />
