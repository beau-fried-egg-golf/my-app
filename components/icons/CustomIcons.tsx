...
export function ClubhouseIcon({ size = 24, color = '#1B1A1A' }: IconProps) {
  return (
...
export function CoursesIcon({ size = 24, color = '#1B1A1A' }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 46 46" fill="none">
      <Path
...
export function MembersIcon({ size = 24, color = '#1B1A1A' }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 46 46" fill="none">
      <Path
...
export function MessagingIcon({ size = 24, color = '#1B1A1A' }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 46 46" fill="none">
      <Path
...
export function NotificationsIcon({ size = 24, color = '#1B1A1A' }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 46 46" fill="none">
      <Path
...
export function MeetupsIcon({ size = 24, color = '#1B1A1A' }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 46 46" fill="none">
      <Path
...
export function GroupsIcon({ size = 24, color = '#1B1A1A' }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 46 46" fill="none">
      <Path
